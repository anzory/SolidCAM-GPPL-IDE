...
- **System catalog** — all **1201 system variable** descriptions and **121 system procedure** descriptions (hover tooltips and completion item details).
